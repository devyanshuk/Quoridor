...
To find an estimate of the average branching factor $B_{avg}$, we use the Algorithm \ref{alg:AverageBranchingFactor}
...
The average branching factor for board of dimension 9x9 was about \textbf{61}, which is very close to the value proposed by \citep{Glendenning2002MasteringQ}
