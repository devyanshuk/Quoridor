...
To find an estimate of the average branching factor $B_avg$, we use the Algorithm \ref{alg:AverageBranchingFactor}
...
We then simulate \textbf{1000} games between \textbf{Minimax AB} and \textbf{Semi-random} agents [\textcolor{red}{Define semi-random agents}], each for boards of dimensions 3, 5, 7 and 9, and the results of the average branching factor can be seen in figure \ref{fig:BranchingFactor}
